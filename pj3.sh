...
menu()
{
    ...
    15) printf "\n"; printf "EXITING..."; sleep 0.8;break; clear ;;
    
    *) printf "\e[91mHEY BITCH! YOU MUST SELECT VAILD NUMBER!"; sleep 1; menu 
    esac
}
...
f_settings()
{
    ...
    *) printf "\e[91mHEY BITCH! YOU MUST SELECT VAILD NUMBER!"; sleep 1; f_settings
    esac
}
...
f_toolscheck()
{
    command -v aircrack-ng >/dev/null 2>&1 || { printf >&2 "\e[91mAIRCRACK-NG SUITE NOT FOUND! INSTALL DEPENDENCIES IN SETTINGS...\n "; }
    command -v netdiscover >/dev/null 2>&1 || { printf >&2 "\e[91mNETDISCOVER NOT FOUND! INSTALL DEPENDENCIES IN SETTINGS...\n "; }
    command -v macchanger >/dev/null 2>&1 || { printf >&2 "\e[91mMACCHANGER NOT FOUND! INSTALL DEPENDENCIES IN SETTINGS...\n "; }
    command -v slowloris >/dev/null 2>&1 || { printf >&2 "\e[91mSLOWLORIS NOT FOUND! INSTALL DEPENDENCIES IN SETTINGS...\n"; }
    command -v traceroute >/dev/null 2>&1 || { printf >&2 "\e[91mTRACEROUTE NOT FOUND! INSTALL DEPENDENCIES IN SETTINGS...\n "; }
    command -v speedtest-cli >/dev/null 2>&1 || { printf >&2 "\e[91mSPEEDTEST-CLI NOT FOUND! INSTALL DEPENDENCIES IN SETTINGS...\n "; }
    command -v nmap >/dev/null 2>&1 || { printf >&2 "\e[91mNMAP NOT FOUND! INSTALL DEPENDENCIES IN SETTINGS...\n "; }
}
