...
menu()
{
    ...
    printf "\e[96m(8) ENABLE MONITOR MODE\n"
    printf "\e[96m(9) CHANGE MAC ADDRES\n"
    printf "\e[96m(10) SETTINGS\n"
    printf "\e[96m(11) EXIT\n"
    printf "\n"
    read -p "OPTION: " menu
    case $menu in
    ...
    11) echo " "; echo "EXITING..."; sleep 1;break; clear ;;
